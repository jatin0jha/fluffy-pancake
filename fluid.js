(function (f, m) {
    typeof exports == "object" && typeof module < "u" ? m(exports) : typeof define == "function" && define.amd ? define(["exports"], m) : (f = typeof globalThis < "u" ? globalThis : f || self, m(f.Veloxi = {
    }
    ))
}
)(this, function (f) {
    ...
    var It = (f, m, P) => m in f ? Ct(f, m, {
        enumerable: !0, configurable: !0, writable: !0, value: P
    }
    ) : f[m] = P;
    ...
    function Ce(o) {
        return o.split("").map((e, t) => e.toUpperCase() === e ? `${t !== 0 ? "-" : ""}
${e.toLowerCase()}
` : e).join("")
    }
    class k {
    ...
    class Ie {
        ...
        constructor(e) {
            ...
            this._eventBus = e, this._observer = new MutationObserver(this._handler.bind(this)), this._observer.observe(document.body, {
                childList: !0, subtree: !0, attributes: !0, attributeOldValue: !0
            }
            )
        }
        _handler(e) {
            ...
            e.forEach(t => {
                ...
                t.addedNodes.forEach(n => {
                    ...
                    if (!(n instanceof HTMLElement) || n.dataset.velViewId || n.parentElement && typeof n.parentElement.dataset.velAdded < "u") return;
                    let r = n;
                ...
                if (i && /data-vel-data-.+/gi.test(i)) {
                    ...
                    if (c && c !== t.oldValue) {
                        ...
                        this._eventBus.emitEvent(O, {
                            pluginId: r, pluginName: u, viewName: h, dataName: g, dataValue: c
                        }
                        )
                    }
    ...
    class ne {
        ...
        constructor(e, t, i, s, n, r, u) {
            ...
            a(this, "_apiData");
            a(this, "_isReady", !1);
            this._id = se(), this._pluginFactory = e, this._pluginName = t, this._registry = i, this._eventBus = s, this._appEventBus = n, this._internalEventBus = new L, this._config = r, this._layoutIdViewMapWaitingToEnter = new Map, this._pluginKey = u, this._apiData = {
            }
        ...
        _createTemporaryView(e) {
            ...
            e.element.remove(), r.style.cssText = "", r.style.position = "absolute", r.style.left = `${t.left + s}
px`, r.style.top = `${t.top - n}
px`, r.style.width = `${i.width}
px`, r.style.height = `${i.height}
px`, r.style.transform = `
      scale3d(${e.scale.x}
, ${e.scale.y}
, 1) rotate(${e.rotation.degrees}
deg)
    `, r.style.pointerEvents = "none", r.dataset.velRemoved = "", document.body.appendChild(r);
            const u = this._registry.createView(r, e.name);
            return u.setAsTemporaryView(), u.styles.position = "absolute", u.styles.left = `${t.left + s}
px`, u.styles.top = `${t.top - n}
px`, u.rotation.setDegrees(e.rotation.degrees, !1), u.scale.set({
                x: e.scale.x, y: e.scale.y
            }
                , !1), u.size.set({
                    width: e._localWidth, height: e._localHeight
                }
                    , !1), e._copyAnimatorsToAnotherView(u), e.onRemoveCallback && u.onRemove(e.onRemoveCallback), u
        }
        onViewRemoved(e) {
        }
    ...
    function W(o, e, t, i, s, n) {
        ...
        const r = new re(o, o.pluginName, e, t, i, s, n), u = new ae(r);
        return o(u), r
    }
    function Se(o) {
    ...
    function w(o) {
        ...
        return {
            value: t, unit: i, valueWithUnit: o
        }
    ...
    class T {
        ...
        get value() {
            return {
                topLeft: this._topLeft, topRight: this._topRight, bottomRight: this._bottomRight, bottomLeft: this._bottomLeft
            }
        }
        equals(e) {
...
%` }
    ...
    function U(o) {
        ...
        const e = o.split(" ").map(i => w(i)), t = {
            value: 0, unit: "", valueWithUnit: "0"
        }
            ;
        switch (e.length) {

            case 1: return new T(e[0], e[0], e[0], e[0]);
            case 2: return new T(e[0], e[1], e[0], e[1]);
            case 3: return new T(e[0], e[1], e[2], e[1]);
            case 4: return new T(e[0], e[1], e[3], e[2]);
            default: return new T(t, t, t, t)
        }
    ...
    function Oe(o, e) {
        ...
        return {
            v: {
                topLeft: t.v, topRight: i.v, bottomRight: n.v, bottomLeft: s.v
            }
            , h: {
                topLeft: t.h, topRight: i.h, bottomRight: n.h, bottomLeft: s.h
            }
        }
            ;
        function r(u, h) {
...
%`)
    ...
    function qe(o) {
        ...
        return {
            viewportOffset: {
                left: Math.round(e.left), top: Math.round(e.top), right: Math.round(e.right), bottom: Math.round(e.bottom)
            }
            , pageOffset: {
    ...
    function Ye(o) {
        ...
        return {
            left: e.left, top: e.top, right: e.right, bottom: e.bottom, width: e.width, height: e.height
        }
    ...
    class je {
        ...
        constructor(e) {
            ...
            this._rect = qe(e), this._computedStyle = getComputedStyle(e), this._element = e
        }
        read(e) {
        ...
        get scroll() {
            ...
            return i += window.scrollX, t += window.scrollY, {
                y: t, x: i
            }
    ...
    function Y(o, e) {
        ...
        const t = {
            set: (i, s, n) => (typeof i[s] == "object" && i[s] !== null ? i[s] = Y(n, e) : (e(), i[s] = n), !0), get: (i, s) => typeof i[s] == "object" && i[s] !== null ? Y(i[s], e) : i[s]
        }
            ;
    ...
    class He extends j {
        ...
        update({
            animatorProp: e, current: t, target: i, dt: s }
        ) {
...
`);
    ...
    const K = {
        stiffness: .5, damping: .75, speed: 10
    }
        , x = .01;
    class G {
    ...
    class Ze extends G {
        ...
        update({
            animatorProp: t, current: i, target: s, dt: n }
        ) {
...
`);
    ...
    class tt extends J {
        ...
        update({
            animatorProp: e, initial: t, target: i, ts: s }
        ) {
            ...
            ), i) : l.add(t, l.scale(l.sub(i, t), this._config.ease(n)))
        }
...
`)
    ...
    class Q {
        ...
        createAnimatorByName(e, t) {
            ...
            switch (e) {
                ...
                case "instant": return this.createInstantAnimator();
                case "dynamic": return this.createDynamicAnimator(t);
                case "tween": return this.createTweenAnimator(t);
                case "spring": return this.createSpringAnimator(t)
            }
    ...
    class R {
        ...
        constructor(e, t, i) {
            ...
            this._animatorProp = new rt(this), this._animatorFactory = e, this._initialValue = A(t), this._previousValue = A(t), this._targetValue = A(t), this._currentValue = A(t), this._hasChanged = !1, this._previousRenderValue = void 0, this._view = i, this._animator = this._animatorFactory.createInstantAnimator()
        }
        get shouldRender() {
            return !0
        }
        ...
        _setTarget(e, t = !0) {
            ...
            var i, s;
            this._previousValue = A(this._currentValue), this._targetValue = e, t ? ((s = (i = this._animator).reset) == null || s.call(i), this.animator.markAsAnimating()) : this._currentValue = e, this._hasChanged = !0
        }
        hasChanged() {
    ...
    class at extends R {
        ...
        get value() {
            return {
                topLeft: this._currentValue[0], topRight: this._currentValue[1], bottomRight: this._currentValue[2], bottomLeft: this._currentValue[3]
            }
        }
        ...
        set(t, i = !0) {
            ...
            if (typeof t == "string") {
                ...
                const c = U(t.trim());
                s = {
                    topLeft: c.value.topLeft.valueWithUnit, topRight: c.value.topRight.valueWithUnit, bottomRight: c.value.bottomRight.valueWithUnit, bottomLeft: c.value.bottomLeft.valueWithUnit
                }

            }
            else s = t;
            const n = s.topLeft ? w(s.topLeft) : this._currentValue[0], r = s.topRight ? w(s.topRight) : this._currentValue[1], u = s.bottomRight ? w(s.bottomRight) : this._currentValue[2], h = s.bottomLeft ? w(s.bottomLeft) : this._currentValue[3];
        ...
        update(t, i) {
            ...
            if (this._forceStyleUpdateThisFrame) this._hasChanged = !0, this._forceStyleUpdateThisFrame = !1;
            else if (this._view.scale.isAnimating && this._updateWithScale) this._hasChanged = !0;
            ...
            this._currentValue = this._animator.update({
                animatorProp: this._animatorProp, current: this._currentValue, target: this._targetValue, initial: this._previousValue, ts: t, dt: i
            }
        ...
        _applyScaleInverse() {
            ...
            this._invertedBorderRadius = Oe(U(`${this._currentValue[0].valueWithUnit}
 ${this._currentValue[1].valueWithUnit}
 ${this._currentValue[2].valueWithUnit}
 ${this._currentValue[3].valueWithUnit}
`).value, {
                width: t, height: i
            }
            )
        ...
        get shouldRender() {
            return this._hasChanged ? this._previousRenderValue ? !(le(this.renderValue.v, this._previousRenderValue.v) && le(this.renderValue.h, this._previousRenderValue.h)) : !0 : !1
        }
        get renderValue() {
            return this.invertedBorderRadius ? {
                v: {
                    topLeft: this.invertedBorderRadius.v.topLeft, topRight: this.invertedBorderRadius.v.topRight, bottomLeft: this.invertedBorderRadius.v.bottomLeft, bottomRight: this.invertedBorderRadius.v.bottomRight
                }
                , h: {
                    topLeft: this.invertedBorderRadius.h.topLeft, topRight: this.invertedBorderRadius.h.topRight, bottomLeft: this.invertedBorderRadius.h.bottomLeft, bottomRight: this.invertedBorderRadius.h.bottomRight
                }
            }
                : {
                    v: {
                        topLeft: this.value.topLeft, topRight: this.value.topRight, bottomLeft: this.value.bottomLeft, bottomRight: this.value.bottomRight
                    }
                    , h: {
                        topLeft: this.value.topLeft, topRight: this.value.topRight, bottomLeft: this.value.bottomLeft, bottomRight: this.value.bottomRight
                    }
        ...
        projectStyles() {
            ...
            const t = this.renderValue, i = `border-radius: ${t.h.topLeft.valueWithUnit}
 ${t.h.topRight.valueWithUnit}
 ${t.h.bottomRight.valueWithUnit}
 ${t.h.bottomLeft.valueWithUnit}
 / ${t.v.topLeft.valueWithUnit}
 ${t.v.topRight.valueWithUnit}
 ${t.v.bottomRight.valueWithUnit}
 ${t.v.bottomLeft.valueWithUnit}
;
`;
    ...
    class ot extends R {
        ...
        update(e, t) {
            ...
            this._currentValue = this._animator.update({
                animatorProp: this._animatorProp, current: this._currentValue, target: this._targetValue, initial: this._previousValue, ts: e, dt: t
            }
            )
        }
        get shouldRender() {
    ...
    class ut extends R {
        ...
        set(e) {
            ...
            if (i.x < 0 || i.x > 1) {
                ...
                console.log(`%c WARNING: ${this._view.name}
.origin.x property can only be a value from 0 to 1`, "background: #885500");
                return
            }
            if (i.y < 0 || i.y > 1) {

                console.log(`%c WARNING: ${this._view.name}
.origin.y property can only be a value from 0 to 1`, "background: #885500");
                return
            }
        ...
        projectStyles() {
            ...
            const e = this.renderValue, t = `transform-origin: ${e.x}
% ${e.y}
%;
`;
            return this._previousRenderValue = e, t
    ...
    class lt extends R {
        ...
        get _parentDiff() {
            ...
            if (t) {
                ...
                const n = t.rect.pageOffset, r = t.getScroll(), u = {
                    left: t.previousRect.viewportOffset.left + r.x, top: t.previousRect.viewportOffset.top + r.y
                }
                    ;
                i = u.left - n.left, s = u.top - n.top
            }
            return {
                parentDx: i, parentDy: s
            }
        ...
        set(t, i = !0) {
            ...
            const n = {
                ...
                ;
            this._setTarget(new l(n.x - this._rect.pageOffset.left, n.y - this._rect.pageOffset.top), i)
        }
        reset(t = !0) {
        ...
        update(t, i) {
            ...
            this._currentValue = this._animator.update({
                animatorProp: this._animatorProp, current: new l(this._currentValue.x * n, this._currentValue.y * r), target: this._targetValue, initial: new l(this._previousValue.x * u, this._previousValue.y * h), ts: t, dt: i
            }
            ), this._currentValue = new l(this._currentValue.x / n, this._currentValue.y / r)
        }
        _runLayoutTransition() {
            ...
            if (n !== 0 || r !== 0 || !Number.isNaN(u) && u !== 1 || !Number.isNaN(h) && h !== 1 ? c = !0 : c = (() => {
                ...
                for (let _ = 0;
                    ...
                    const d = g[_], v = d.previousRect.size.width / d.rect.size.width, y = d.previousRect.size.height / d.rect.size.height;
                    if (v !== 1 || y !== 1) return !0
                }
                return !1
            }
                ...
                if (this._currentValue.x !== 0 || this._currentValue.y !== 0 || this._view.scale._currentValue.x !== 1 || this._view.scale._currentValue.y !== 1) {
                    ...
                    if (!s) {
                        ...
                        const M = this._rect.pageOffset.left - this._previousRect.pageOffset.left, D = this._rect.pageOffset.top - this._previousRect.pageOffset.top;
                        this._setTarget(new l(this._currentValue.x - M, this._currentValue.y - D), !1);
                        return
                    }
                    const V = this._view._parent, Ve = this._rect.pageOffset, Pe = this._view.getScroll(), F = {
                        left: this._previousRect.viewportOffset.left + Pe.x, top: this._previousRect.viewportOffset.top + Pe.y
                    }
                        , xt = F.left - Ve.left, Tt = F.top - Ve.top;
                    let be = 0, Re = 0, Ee = 0, xe = 0;
                    if (V && V.position.animator.name !== "instant") {

                        const M = V.rect.pageOffset, D = V.getScroll(), $ = {
                            left: V.previousRect.viewportOffset.left + D.x, top: V.previousRect.viewportOffset.top + D.y
                        }
                            ;
                        be = $.left - M.left, Re = $.top - M.top;
                        const Te = F.top - $.top, Ae = F.left - $.left, At = V.scale.y * Te;
                        Ee = (Te - At) / V.scale.y;
                        const Nt = V.scale.x * Ae;
                        xe = (Ae - Nt) / V.scale.x
                    }
                    this._setTarget(new l(xt - be + xe, Tt - Re + Ee), !1), s && (this._animateLayoutUpdateNextFrame = !0);
                    return
                }
                this._animateLayoutUpdateNextFrame = !0;
                const g = this._previousRect, _ = this._rect, d = this._view._parent;
                let v = 0, y = 0;
                d && d.position.animator.name !== "instant" && (v = d.previousRect.viewportOffset.left - d.rect.viewportOffset.left), d && d.position.animator.name !== "instant" && (y = d.previousRect.viewportOffset.top - d.rect.viewportOffset.top);
                let b = 1, te = 1;
                d && d.scale.animator.name !== "instant" && (b = d.previousRect.size.width / d.rect.size.width, te = d.previousRect.size.height / d.rect.size.height);
                const yt = d && d.position.animator.name !== "instant" ? d.previousRect.viewportOffset.left : 0, Vt = d && d.position.animator.name !== "instant" ? d.previousRect.viewportOffset.top : 0, we = g.viewportOffset.left - yt, ye = g.viewportOffset.top - Vt, Pt = we / b - we, bt = ye / te - ye;
...
px, 0)`;
    ...
    class ht extends R {
        ...
        projectStyles() {
            ...
            const t = this.renderValue, i = `rotate(${t}
${this._unit}
)`;
            return this._previousRenderValue = t, i
        }
    ...
    class ct extends R {
        ...
        update(t, i) {
            ...
            this._targetValue.x === this._currentValue.x && this._targetValue.y === this._currentValue.y || (this._currentValue = this._animator.update({
                animatorProp: this._animatorProp, current: this._currentValue, target: this._targetValue, initial: new l(this._previousValue.x, this._previousValue.y), ts: t, dt: i
            }
            ))
        }
        _runLayoutTransition() {
            ...
            if ((!Number.isNaN(i) && i !== 1 || !Number.isNaN(s) && s !== 1) && (n = !0), n) {
                ...
                if (this._currentValue.x !== 1 || this._currentValue.y !== 1) {
                    ...
                    this._setTarget(new l(this._currentValue.x * g, this._currentValue.y * _), !1), t && (this._animateLayoutUpdateNextFrame = !0);
                    return
                }
        ...
        projectStyles() {
            ...
            const t = this.renderValue, i = `scale3d(${t.x}
, ${t.y}
, 1)`;
            return this._previousRenderValue = t, i
        }
    ...
    class dt extends R {
        ...
        projectStyles() {
            ...
            const e = this.renderValue, t = `width: ${e.x}
px;
 height: ${e.y}
px;
`;
    ...
    class gt {
        ...
        constructor(e) {
            ...
            this._props.set("position", new lt(new S, new l(0, 0), e)), this._props.set("scale", new ct(new S, new l(1, 1), e)), this._props.set("rotation", new ht(new he, 0, e)), this._props.set("size", new dt(new S, new l(e.rect.size.width, e.rect.size.height), e)), this._props.set("opacity", new ot(new he, e.elementReader.opacity.value, e)), this._props.set("borderRadius", new at(new nt, [e.elementReader.borderRadius.value.topLeft, e.elementReader.borderRadius.value.topRight, e.elementReader.borderRadius.value.bottomRight, e.elementReader.borderRadius.value.bottomLeft], e)), this._props.set("origin", new ut(new S, e.elementReader.origin.value, e))
        }
        allProps() {
    ...
    class _t {
        ...
        constructor(e, t, i, s) {
            ...
            this.id = se(), this.name = t, this.element = e, this._elementReader = q(e), this._previousRect = this._elementReader.rect, this._viewProps = new gt(this), this._skipFirstRenderFrame = !0, this._layoutId = s, this._layoutTransition = !1, this._registry = i, this.element.dataset.velViewId = this.id, this._temporaryView = !1, this._inverseEffect = !1, this.styles = Y(this.styles, () => {
        ...
        setElement(e) {
            this.element = e, this._elementReader = q(this.element), this.element.dataset.velViewId = this.id
        }
        get layoutId() {
        ...
        get _parent() {
            ...
            if ((i = t == null ? void 0 : t.dataset) != null && i.velViewId) return this._registry.getViewById(t.dataset.velViewId)
        }
        get _parents() {
            ...
            if (!t) return e;
            for (t = t.closest("[data-vel-view-id]");
                t;
            ) {
                ...
                t = (i = t.parentElement) == null ? void 0 : i.closest("[data-vel-view-id]")
            }
            return e
        }
        get rotation() {
        ...
        get data() {
            ...
            return Object.keys(e).filter(s => s.includes("velData")).map(s => s.replace("velData", "")).map(s => `${s[0].toLowerCase()}
${s.slice(1)}
`).reduce((s, n) => {

                const r = e[`velData${n[0].toUpperCase()}
${n.slice(1)}
`];
        ...
        intersects(e, t) {
            ...
            const i = {
                x: this.rect.viewportOffset.left, y: this.rect.viewportOffset.top
            }
                ;
        ...
        render() {
            ...
            if (i.some(n => n.hasChanged())) {
                ...
                const n = i.reduce((r, u, h) => (r += u.projectStyles(), h === i.length - 1 && (r += ";
"),r),"transform: ");
e += n}
            s.forEach(n => {
        ...
        _getUserStyles() {
            ...
            return Object.keys(this.styles).reduce((e, t) => t ? e + `${Ce(t)}
: ${this.styles[t]}
;
`: e, "")
        }
    ...
    class pt {
        ...
        _handleAddedViews() {
            ...
            const e = this._viewsToBeCreated.filter(s => this._isScopedElement(s)), t = this._viewsToBeCreated.filter(s => !this._isScopedElement(s));
            this._viewsToBeCreated = [], e.forEach(s => {

                const n = this._getPluginNameForElement(s), r = this._pluginNameToPluginFactoryMap.get(n), u = this._pluginNameToPluginConfigMap.get(n), h = s.dataset.velPluginKey, c = W(r, this, this._eventBus, this._appEventBus, u, h);
...
`
        ...
        _createChildrenForView(e, t) {
            ...
            if (i.length) {
                ...
                if (Array.from(i).some(s => this._getPluginNameForElement(s) !== t.pluginName)) {

                    console.log(`%c WARNING: The plugin "${t.pluginName}
" has view(s) created for a different plugin. Make sure all views inside that plugin don't have data-vel-plugin set or the pluginName is set to "${t.pluginName}
"`, "background: #885500");
                    return
                }
                Array.from(i).forEach(s => {

                    const n = s, r = n.dataset.velView ? n.dataset.velView : `${e.name}
-child`, u = this._getLayoutIdForElement(n, t), h = this.createView(n, r, u);
        ...
        _destroyPlugin(e) {
            ...
            ), this._views = this._views.filter(i => !t.find(s => s.id === i.id)), this._viewsPerPlugin.delete(e.id), this._plugins = this._plugins.filter(i => i.id !== e.id)
        }
        _destroyAll(e) {
        ...
        _resetPlugin(e) {
            ...
            ), this._views = this._views.filter(u => !r.find(h => h.id === u.id)), this._viewsPerPlugin.delete(e.id), this._plugins = this._plugins.filter(u => u.id !== e.id), n || requestAnimationFrame(() => {
        ...
        notifyPluginAboutDataChange(e) {
            ...
            !t || !t.length || t.forEach(i => {
                i.notifyAboutDataChanged({
                    dataName: e.dataName, dataValue: e.dataValue, viewName: e.viewName
                }
                )
            }
            )
        ...
        createPlugin(e, t, i = {
            ...
            if (!e.pluginName) throw Error(`Plugin ${e.name}
 must contain a pluginName field`);
            let s = [];
            if (e.scope) {

                const u = document.querySelectorAll(`[data-vel-plugin=${e.pluginName}
][data-vel-view=${e.scope}
]`);
                this._pluginNameToPluginFactoryMap.has(e.pluginName) || this._pluginNameToPluginFactoryMap.set(e.pluginName, e), this._pluginNameToPluginConfigMap.has(e.pluginName) || this._pluginNameToPluginConfigMap.set(e.pluginName, i), u ? s = Array.from(u) : s = [document.documentElement]
            }
            else s = [document.documentElement];
            const n = s.map(u => {

                const h = u.dataset.velPluginKey, c = W(e, this, t, this._appEventBus, i, h);
                this._plugins.push(c);
                let g = [];
            ...
            return e.scope || console.log(`%c WARNING: The plugin "${r.pluginName}
" is created but there are no elements using it on the page`, "background: #885500"), r
        }
        getViews() {
            return this._views
        }
    ...
    class ee {
        ...
        constructor() {
            ...
            a(this, "_eventBus");
            a(this, "_appEventBus");
            this._eventBus = new L, this._appEventBus = new L, this._registry = new pt(this._appEventBus, this._eventBus), new Ie(this._eventBus)
        }
        static create() {
            return new ee
        }
        ...
        getPlugin(e, t) {
            ...
            if (!s) throw new Error(`You can't call getPlugin for ${i}
 with key: ${t}
 because it does not exist in your app`);
            return s.api
        }
        getPlugins(e, t) {
            ...
            if (s.length === 0) throw new Error(`You can't call getPlugins for ${i}
 with key: ${t}
 because they don't exist in your app`);
        ...
        _tick(e) {
            ...
            t > .016 && (t = 1 / 60), this._previousTime = e, this._eventBus.reset(), this._subscribeToEvents(), this._read(), this._update(e, t), this._render(), requestAnimationFrame(this._tick.bind(this))
        }
        _subscribeToEvents() {
            this._eventBus.subscribeToEvent(k, this._onNodeAdded.bind(this)), this._eventBus.subscribeToEvent(z, this._onNodeRemoved.bind(this)), this._eventBus.subscribeToEvent(O, this._onDataChanged.bind(this)), this._registry.getPlugins().forEach(e => {
    ...
    class _e extends B {
            ...
            t.subscribeToEvent(C, ({
                ...
                this._pointerX = i, this._pointerY = s, this.getViews().forEach(n => {
                    ...
                    if (this._pointerDownPerView.get(n.id) && this._initialPointerPerView.get(n.id)) {
                        ...
                        u && u.push(new l(i, s));
                        const h = u && u.length >= 2 ? u[u.length - 2] : r.clone(), c = this._calculateDirections(h, r);
                        this._emitEvent(n, c)
                    }
        ...
        _emitEvent(t, i) {
            ...
            const y = {
                view: t, target: d, previousX: h, previousY: c, x: r, y: u, width: _, height: g, isDragging: v, directions: i
            }
                ;
            this.emit(ge, y)
        }
        _calculateDirections(t, i) {
            ...
            const s = {
                up: l.sub(new l(t.x, t.y - 1), t), down: l.sub(new l(t.x, t.y + 1), t), left: l.sub(new l(t.x - 1, t.y), t), right: l.sub(new l(t.x + 1, t.y), t)
            }
            ...
            ].filter(h => h.projection > 0).map(h => h.direction)
        }
        ...
        subscribeToEvents(t) {
            ...
            t.subscribeToEvent(C, ({
                ...
                this.getViews().forEach(r => {
                    ...
                    if (!this._viewIsPointerDownMap.get(r.id) || !this._viewPointerPositionLog.has(r.id)) return;
                    const u = new l(i, s), h = this._viewPointerPositionLog.get(r.id), c = h[h.length - 2] || u.clone(), g = this._targetPerView.get(r.id), _ = n(c, u);
                    g && r.hasElement(g) && _.hasSwiped && this.emit(pe, {
                        view: r, direction: _.direction
                    }
                ...
                function n(r, u) {
                    ...
                    const h = {
                        up: l.sub(new l(r.x, r.y - 1), r), down: l.sub(new l(r.x, r.y + 1), r), left: l.sub(new l(r.x - 1, r.y), r), right: l.sub(new l(r.x + 1, r.y), r)
                    }
                        , c = l.sub(u, r).unitVector, g = ["up", "down", "left", "right"], _ = [c.dot(h.up), c.dot(h.down), c.dot(h.left), c.dot(h.right)], d = Math.max(..._), v = _.indexOf(d), y = g[v], b = l.sub(u, r).magnitude;
                    return {
                        hasSwiped: c.dot(h[y]) * b > 30, direction: y
                    }
        ...
        subscribeToEvents(e) {
            ...
            e.subscribeToEvent(P, ({
                ...
                this.getViews().forEach(n => {
                    ...
                    n.intersects(t, i) && u && this.emit(me, {
                        view: n
                    }
                    )
                }
    ...
    const vt = Object.freeze(Object.defineProperty({
        __proto__: null, clamp: oe, minBy: mt, pointToViewProgress: De, remap: Me, valueAtPercentage: Fe
    }
        , Symbol.toStringTag, {
        value: "Module"
    }
    )), wt = Object.freeze(Object.defineProperty({
        __proto__: null, PointerClickEvent: P, PointerDownEvent: C, PointerMoveEvent: N, PointerUpEvent: I
    }
        , Symbol.toStringTag, {
        value: "Module"
    }
    ));
    f.ClickEvent = me, f.ClickEventPlugin = ve, f.DataChangedEvent = O, f.DragEvent = ge, f.DragEventPlugin = _e, f.EventBus = L, f.EventPlugin = B, f.Events = wt, f.Plugin = re, f.PluginContext = ae, f.SwipeEvent = pe, f.SwipeEventPlugin = fe, f.Utils = vt, f.createApp = ft, Object.defineProperty(f, Symbol.toStringTag, {
        value: "Module"
    }
    )
}
